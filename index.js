...
function game(user, computer){
  // If computer choice is 0 computerChoice = 'rock'
  // If computer choice is 1 computerChoice = 'paper'
  // If computer choice is 2 computerChoice = 'scissors'
  switch(computer) {
    case 0:
      computer = 'rock';
      break;
...
function vowelCounter(str) {
  let vowels = str.includes(['a', 'e', 'i', 'o', 'u']);
  return vowels;
}
